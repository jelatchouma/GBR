...
<html lang="fr">
    ...
    <?php
        ...
        //Preparation de la requête afin de selectionner toute les bureaux relevant du 2eme etage
        $pdoStat = $objetPdo->prepare('SELECT id_emplacement FROM emplacement WHERE type_emplacement LIKE "Bureau" AND etage_emplacement LIKE "Etage02" ');
      ...
      <center><img class="logo_site" src="../../img/logo_esic.png"></center>
       ...
       <a href="../add/add_prise.php"><img class="ajout_prise" src="../../img/icone_ajout.png"></a>
        ...
        <div class="titre_index">
            <h1>Selectionnez un bureau du 2eme etage</h1>
        </div>
            <div class="galerie">
            ...
            <?php foreach ($emplacements as $emplacement): ?>
                ...
                <a class="box" href="../change/list_changeb2.php?numemplacement=<?= $emplacement['id_emplacement']?>"><?= $emplacement['id_emplacement']?></a>
