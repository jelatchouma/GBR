...
<html lang="fr">
    ...
    <!-- Ce fichier php sert à lister les salles de réunion du 3eme etage -->
    <?php
    ...
    <nav class="sidenav">
        <a href="../place/sdr_3eme.php"><img class="retour" src="../../img/icone_retour.png"></a>
        ...
        <center>
            ...
            <!-- Affichage des prises et des informations nécessaire -->
                    <tr>
                        ...
                        <td><a href="form_change.php?numprise=<?= $prise['id_prise'] ?>"class="maj">Modifier</a></td> <!--Renvoi vers le formulaire de modification "form_change.php" avec récupération de l'id d'emplacement --> 
                    </tr>
                <?php endforeach; ?> 
            </table>
            </section>
