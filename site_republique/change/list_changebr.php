...
<html lang="fr">
    ...
    <!-- Ce fichier php sert à lister les bureaux du RDC -->
    <?php
    session_start();
    ...
    $pdoNum= $objetPdo->prepare('SELECT id_prise, etat_fonct, etat_brassage, cable_connect, observation_prise FROM prise WHERE lieu_prise5 = :num');
    ...
    <nav class="sidenav">
        <a href="../place/bureaux_rdc.php"><img class="retour" src="../../img/icone_retour.png"></a>
           ...
           <table>
            ...
            <!-- Affichage des prises et des informations nécessaire -->
                    <tr>
                        ...
                        <td><a href="../change/form_change.php?numprise=<?= $prise['id_prise'] ?>"class="maj">Modifier</a></td> <!--Renvoi vers le formulaire de modification "form_change.php" avec récupération de l'id d'emplacement --> 
                    </tr>
                <?php endforeach; ?> 
            </table>
            </section>
