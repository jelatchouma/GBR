...
<!-- Ce fichier php sert à lister les bureaux du 1er etage -->
<?php
    ...
    $pdoNum= $objetPdo->prepare('SELECT id_prise, etat_fonct, etat_brassage, cable_connect, observation_prise FROM prise WHERE lieu_prise6 = :num');
...
<body>
    ...
    <nav class="sidenav">
        <a href="../place/bureaux_1er.php"><img class="retour" src="../../img/icone_retour.png"></a>
    ...
    <br>
    <a href="../place/bureaux_1er.php">Retour</a>
